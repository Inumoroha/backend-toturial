...
本节目标：掌握 Scope 的设计方式，用它复用分页、状态过滤、租户过滤等通用查询条件。
...
Scope 适合通用查询条件，不适合复杂业务流程。

复杂查询可以直接写 Repository 方法。
...
这一节不要只停留在“看懂概念”。建议你按下面的方式把「Scope复用查询条件」练成可以在项目中使用的能力。
