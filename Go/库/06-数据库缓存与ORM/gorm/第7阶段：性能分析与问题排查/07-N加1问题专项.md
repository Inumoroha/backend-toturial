...
本节目标：识别、复现并修复 GORM 中常见的 N+1 查询问题。N+1 是 ORM 项目最典型的性能坑。

---

## 一、什么是 N+1

先查 N 条主数据，再循环查 N 次关联数据。
...
如果有 100 篇文章，就有 101 条 SQL。

---

## 二、如何发现

打开 SQL 日志，观察是否出现大量重复 SQL：
...
这一节不要只停留在“看懂概念”。建议你按下面的方式把「N加1问题专项」练成可以在项目中使用的能力。
